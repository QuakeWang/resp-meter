...
impl Display for Histogram {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        write!(
            ...
            "cnt: {}, avg: {}, p99: {}, p999: {}",
            cnt,
            Histogram::humanize_us(avg),
            Histogram::humanize_us(p99),
            Histogram::humanize_us(p999)
        )
    }
}
...
mod tests {
    ...
    fn test() {
        ...
        let dst = [
            0, 0, 10, 90, 100, 990, 1_000, 9_900, 10_000, 99_000, 100_000, 990_000, 1_000_000,
            9_900_000, 10_000_000, 10_000_000, 10_000_000,
        ];
        for i in 0..src.len() {
            let histogram = Histogram::new();
            for _ in 0..1000 {
